/**
 * ManagementManagerAnnouncements.jsx
 * Announcement Management for the Management Manager role.
 * Same design as Sales Manager announcements — reuses common announcement service.
 * Audience options: All, Team, Team Leaders, Employee
 */
...
const blank = { type: "", audience: "", targetId: "", title: "", body: "", expiryDate: "" };
...
export default function ManagementManagerAnnouncements() {
  ...
  useEffect(() => {
    fetchAnnouncementMeta()
      ...
      .catch(() => {
        ...
        setAudienceOptions(["All", "Team", "Team Leaders", "Employee"]);
      })
  ...
  useEffect(() => {
    if (!form.audience || form.audience === "All") { setTargets([]); return; }
  ...
  const actions = [
    {
      ...
      onClick: (row) => { setViewRow(row); openModal("mm-ann-view-modal"); },
    },
  ];
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
        ...
        <Grid cols={12} gap={4}>
          ...
          <div className="col-span-12 sm:col-span-6">
            <SelectField label="Message Type *" id="mm-ann-type" size={12}
              placeholder="Select type..." value={form.type}
          ...
          {/* Audience */}
          <div className="col-span-12 sm:col-span-6">
            <SelectField label="Send To *" id="mm-ann-audience" size={12}
              placeholder="Select audience..." value={form.audience}
              onChange={(e) => { setField("audience", e.target.value); setField("targetId", ""); setTargets([]); }}>
          ...
          {needsTarget && (
            <div className="col-span-12 sm:col-span-6">
              {targetsLoading ? (
                ...
                <>
                  <SelectField label={`Select ${form.audience} *`} id="mm-ann-target" size={12}
          ...
          <div className="col-span-12 sm:col-span-6">
            <DatePicker
              label="Expiry Date (optional)" id="mm-ann-expiry"
          ...
          <div className="col-span-12">
            <DataField label="Title *" id="mm-ann-title" size={12}
              value={form.title}
          ...
          {/* Message */}
          <div className="col-span-12">
            <DataField label="Message *" id="mm-ann-body" type="textarea" rows={4} size={12}
              value={form.body}
            ...
            <div className="col-span-12">
              ...
              <div className={`rounded-2xl border p-5 space-y-3 transition-all ${TYPE_STYLE[form.type] || "bg-blue-50 border-blue-200"}`}>
                ...
                <p className="text-[10px] text-slate-400 pt-1">
                  From: Management Manager &nbsp;·&nbsp; {new Date().toLocaleDateString("en-IN", { day:"2-digit", month:"short", year:"numeric" })}
                </p>
              </div>
            </div>
          )}
          ...
          {submitErr && (
            <div className="col-span-12">
              <p className="text-xs text-rose-600 bg-rose-50 border border-rose-200 rounded-xl px-4 py-2">{submitErr}</p>
            </div>
          )}
          ...
          <div className="col-span-6">
            <Button text={submitting ? "Sending…" : "Send Announcement"} variant="primary"
      ...
      <DataTable
        ...
        actions={actions}
        size={12} pageSize={10} searchable exportable exportFileName="announcements"
        filters={[
          { title: "Type",     type: "toggle", key: "type",     options: ["Announcement","Warning","Appreciation"] },
          { title: "Audience", type: "toggle", key: "audience", options: ["All","Team","Team Leaders","Employee"] },
          { title: "Status",   type: "toggle", key: "status",   options: ["Active","Expired"] },
        ]}
      />

      {/* View Modal */}
      <Modal id="mm-ann-view-modal" title="Announcement Details" size="xl">
        {viewRow && (
          <div className="flex flex-col gap-4">
            ...
            <div className="flex justify-end pt-2 border-t border-slate-100">
              <Button text="Close" variant="ghost" size={3} onClick={() => closeModal("mm-ann-view-modal")} />
            </div>
          </div>
        )}
      </Modal>
